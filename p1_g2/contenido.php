...
EOS;
    ...
    if ($_SESSION["tipo"] == 0) {
        ...
        <div style="text-align: center; padding: 20px;">
            ...
            <a href="EditarActividad.php" style="display: inline-block; padding: 10px 20px; margin: 10px; background-color: #ffc107; color: black; text-decoration: none; border-radius: 5px;">
                Modificar Actividad
            </a>
        </div>
EOS;
