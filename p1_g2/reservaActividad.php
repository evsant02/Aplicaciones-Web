...
// Simular reserva ---> HAY QUE COMPROBAR QUE EL USUARIO NO HAYA RESERVADO YA ANTERIORMENTE ESTA ACTIVIDAD
if (isset($_POST['reservar']) && $actividad && $actividad->getPlazas() > 0 && $actividad->getVoluntario() !== null) {
    $_SESSION['reservas'][] = $actividad->getId();
...
<body>
    <?php if ($actividad && $actividad->getDirigida() && $actividad->getVoluntario() !== null): ?>
        <div class="actividad">
            ...
            <!-- Contenedor de los detalles de la actividad -->
            <div class="actividad-detalles">
                ...
                <p><strong>Dirigido por:</strong> <?php echo $actividad->getVoluntario(); ?></p>
                <p><strong>Plazas disponibles:</strong> <?php echo $actividad->getPlazas(); ?></p>

                <!-- Formulario para reservar -->
                <?php if ($actividad->getPlazas() > 0): ?>
                    <form method="post">
                        <button type="submit" name="reservar">Reservar mi plaza</button>
                    </form>
                <?php else: ?>
    ...
    <?php else: ?>
        <p>Actividad no disponible para reserva.</p>
    <?php endif; ?>
</body>
</html>
